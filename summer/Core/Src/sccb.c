...
{											   	 
 	...
 	__HAL_RCC_GPIOB_CLK_ENABLE();
	  ...
	  GPIO_InitStructure.Pin = OV7670_SIO_D_Pin;				     //����SDA��Ӧ����IO���
	  GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP; 		 //����SDA��Ӧ����IO����״̬Ϊ�������
	  GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_HIGH;		 //����SDA��Ӧ����IO�����ٶ�Ϊ50MHZ
	  HAL_GPIO_Init(GPIOB, &GPIO_InitStructure);					     //��ʼ��SDA��Ӧ����IO
}	
...
{											   	 
  ...
  GPIO_InitStructure.Pin = OV7670_SIO_D_Pin;				     //����SDA��Ӧ����IO���
  GPIO_InitStructure.Mode = GPIO_MODE_INPUT; 		   //����SDA��Ӧ����IO����״̬Ϊ��������
  GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_HIGH;		 //����SDA��Ӧ����IO�����ٶ�Ϊ50MHZ
  HAL_GPIO_Init(GPIOB, &GPIO_InitStructure);					     //��ʼ��SDA��Ӧ����IO
}	
...
uint8_t SCCB_Write_Reg(uint8_t reg,uint8_t data)
{
	uint8_t temp=0;
	SCCB_Start(); 					            //����SCCB����
	if(SCCB_WriteAbyte(OV7670_ID))temp=1;	                          //д����ID
	sw_delay_us(100);
	if(SCCB_WriteAbyte(reg))temp=1;		                        //д�Ĵ�����ַ
	sw_delay_us(100);
	if(SCCB_WriteAbyte(data))temp=1; 	                        //д����
	SCCB_Stop();	                      //����SCCB����
	return	temp;
}		  					    
